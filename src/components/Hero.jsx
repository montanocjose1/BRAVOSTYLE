    ...
    <section className="relative h-screen w-full overflow-hidden">
      ...
      <div className="relative z-10 h-full flex flex-col justify-center px-6 max-w-7xl mx-auto">
        ...
        <p className="mt-6 max-w-md text-off-white/70 text-sm md:text-base leading-relaxed font-light">
          Esenciales oversize premium diseñados para la confianza, comodidad y presencia.
        </p>
      ...
      <div className="absolute bottom-10 left-6 md:left-10 z-20 flex items-center gap-5">
        ...
        <a
          ...
          className="group flex items-center gap-2 text-off-white/60 hover:text-off-white transition-all duration-300"
        >
        ...
        <a
          ...
          target="_blank"
          rel="noopener noreferrer"
          className="text-off-white/60 hover:text-off-white transition-all duration-300 hover:scale-110"
        >
